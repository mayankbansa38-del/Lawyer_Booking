        ...
        <div className="w-full max-w-[420px] space-y-8">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="w-auto flex items-center justify-center gap-3 py-2.5 px-8 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 text-gray-700 font-medium transition-colors shadow-sm"
            >
