                    ...
                    <div className="hidden md:flex items-center gap-3">
                        ...
                        <div className="relative" ref={notificationRef}>
                            ...
                            >
                                ...
                                {unreadCount > 0 && (
                                    <span className="absolute -top-1 -right-1 w-5 h-5 bg-red-500 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg pointer-events-none">
